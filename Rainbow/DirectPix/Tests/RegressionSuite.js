/**
 * DirectPix: все тесты папки одним прогоном.
 *
 *   node DirectPix/Tests/RegressionSuite.js
 *
...
if (failed.length) {
  console.error("DirectPix RegressionSuite: упало " + failed.length + " из " + tests.length + ": " + failed.join(", "));
  process.exit(1);
}
console.log("DirectPix RegressionSuite: OK (" + tests.length + " тестов)");
